...
- [Domain-lattice SAE method validation](2026-07-18-domain-lattice-sae-method-validation.md): Infrastructure implemented; synthetic recovery gates the fixed-layer SMAC–GRF–POGEMA study.
