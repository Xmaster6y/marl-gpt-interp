...
- [Environment mechanism probes](2026-07-06-environment-mechanism-probes.md): Initial JZ subset runs completed; wrong-token activations still decode true environment nearly perfectly after the first transformer block.
