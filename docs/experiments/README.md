...
- [Domain-lattice SAE method validation](2026-07-18-domain-lattice-sae-method-validation.md): Balanced core diagnostic and 12-group full-mixture SAE suite are implemented; launch remains exploratory until episode provenance is authoritative.
