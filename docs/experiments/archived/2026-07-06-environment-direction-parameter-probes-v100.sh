...
uv run --no-sync --python 3.12.11 --group grf -m scripts.run_experiment \
    env_mechanism_probes=2026-07-06-jz-directions \
    hydra.run.dir="results/hydra/2026-07-06-environment-direction-parameter-probes/${SLURM_JOB_ID}"
