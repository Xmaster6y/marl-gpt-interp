...
MARL-GPT is the main model substrate. The project will inspect whether GRF-trained MARL-GPT representations encode football concepts such as possession, pressure, spacing, support, and pass or shot affordances. These analyses connect to active questions on [coordination representations](../questions/2026-06-30-coordination-representations-in-marl-gpt.md), the [simulation-human modelling gap](../questions/2026-06-30-simulation-human-modelling-gap.md), and [interpretability-guided alignment](../questions/2026-06-30-interpretability-guided-alignment.md).
